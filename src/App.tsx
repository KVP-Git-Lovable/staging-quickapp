...
import ZohoBooksSync from "./pages/ZohoBooksSync";
...
<Route path="/territories-and-distributors" element={<ProtectedRoute><TerritoriesAndDistributors /></ProtectedRoute>} />
        ...
        <Route path="/event/:id/edit" element={<ProtectedRoute><EventCreate /></ProtectedRoute>} />
        ...
        <Route path="/admin/price-simulator" element={<ProtectedRoute><PriceSimulator /></ProtectedRoute>} />
        ...
        <Route path="/admin/zoho-sync" element={<ProtectedRoute><ZohoBooksSync /></ProtectedRoute>} />
